...
struct Square: ChartSymbolShape, InsettableShape {
    ...
    func path(in rect: CGRect) -> Path {
        ...
        return Path(roundedRect: .init(x: rect.midX - minDimension / 2,
    ...
    var perceptualUnitRect: CGRect {
        // The width of the unit rectangle (square).
        // Adjust this to size the diamond symbol so it perceptually matches with the circle.
